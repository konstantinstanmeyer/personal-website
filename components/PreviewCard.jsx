...
export default function ProjectCard({ project }){
    const { name, description, projectUrl, util, frontEnd, backEnd } = project;

    return (
        <div className="w-[21rem] transition-all duration-300 h-fit rounded-lg bg-gray-700 hover:bg-gray-600 pb-1 mx-auto px-2 relative pt-1 my-6">
            <div className={`mt-7 bg-keyboard-app w-[20rem] h-[10rem] bg-center bg-cover relative rounded-lg`}>
