...
export default function ProjectCard({ project }){
    ...
    return (
        <div className="w-[21rem] mb-10 transition-all duration-300 h-[23rem] rounded-lg bg-gray-700 hover:bg-gray-600 pb-1 mx-auto px-2 relative pt-1 my-6">
            ...
            <img className="rounded-lg h-48 w-full object-cover" src={image} />
