...
export default function ProjectCard({ project }){
    ...
    return (
        <div className="lg:w-[45%] md:w-full mb-20 transition-all duration-300 h-fit lg:h-[32rem] rounded-md bg-black/80 backdrop-blur-sm pb-1 mx-auto px-2 relative pt-1">
            ...
            <Image loading="lazy" className="rounded-sm w-[95%] mx-auto object-cover aspect-video" width={800} height={450} src={image} />
            ...
            <div className="flex flex-row justify-center w-full absolute bottom-3">
                ...
                <button className="text-neutral-900 bebas bg-purple-600 mr-auto ml-2 px-2 py-1 rounded-md hover:bg-purple-500 hover:text-neutral-800 transition-all duration-300 flex flex-row">
                    <p>DEMO</p>
