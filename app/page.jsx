...
export default function HomePage(){
  return(
    ...
    <div className="mx-auto flex flex-col justify-center relative z-30">
      ...
      <div className="w-4/5 sm:w-3/5 font-outfit mx-auto flex flex-row select-none relative duration-500 transform transition-all translate-y-12 ease-out">
        <div className="transition-all ease-in duration-700 h-screen flex flex-col justify-center">
          <h1 className="text-5xl sm:text-8xl font-bold text-purple-700  break-word -mt-16 sm:-mt-12">Konstantin Stanmeyer</h1>
          <h4 className="text-3xl sm:text-6xl text-purple-500 break-word font-bold">Full-Stack Software Engineer</h4>
          <div id="menu" className="flex flex-row items-center font-bold text-gray-400 mt-2">
            ...
            <Link className="text-purple-400 hover:underline bebas sm:text-3xl text-xl rounded-md mr-4" href="resume">
              RESUME
            </Link>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:w-1/2 w-5/6 md:w-3/5 mx-auto h-[75vh] -mt-2 justify-center relative">
        ...
        <p className="text-purple-500 font-righteous text-4xl mb-3">technical skills</p>
        <div className="flex flex-wrap items-center justify-center w-full mx-auto">
          ...
          <div className="rounded-full bg-neutral-500/20 backdrop-blur-sm w-20 md:w-28 aspect-square md:mx-2 lg:mx-4 flex justify-center items-center my-2 mx-1 hover:scale-105 transition-translate duration-300 hover:brightness-110">
            <img alt="typescript" src="/typescript.png" className="w-[80%] h-[80%] rounded-full" />
          </div>
      ...
      <div id="five" className="h-[20vh] flex flex-col items-center justify-center mb-10">
        <p className="text-purple-300 font-righteous font-bold text-sm sm:text-lg md:text-2xl">Contact:</p>
        <p className="text-purple-300 font-righteous font-bold text-sm sm:text-lg md:text-2xl">konstantin@stanmeyer.com</p>
      </div>
    </div>
    </>
  )
